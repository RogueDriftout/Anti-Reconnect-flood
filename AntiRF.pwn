...
new 
    ifile[256],pIPAddress[MAX_PLAYERS][32],//Put the above on top of the script 
    iday[MAX_PLAYERS],iyear[MAX_PLAYERS],imonth[MAX_PLAYERS],ihour[MAX_PLAYERS],isec[MAX_PLAYERS],imin[MAX_PLAYERS]; 
...
{ 
    ...
    { 
        if(iyear[playerid] == dini_Int(ifile,"YEAR") && imonth[playerid] == dini_Int(ifile,"MONTH") 
        && iday[playerid] == dini_Int(ifile,"DAY") && ihour[playerid] == dini_Int(ifile,"HOUR") 
        && dini_Int(ifile,"MINUTE") == imin[playerid]) 
        { 
